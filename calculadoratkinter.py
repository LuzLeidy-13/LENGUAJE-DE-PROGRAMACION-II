...
tk.Label(ventana, text="Número A:", font=("Arial", 11)).pack(pady=5)
entry_a = tk.Entry(ventana, font=("Arial", 12))
entry_a.pack()

tk.Label(ventana, text="Número B:", font=("Arial", 11)).pack(pady=5)
...
tk.Label(ventana, textvariable=resultado, font=("Arial", 14), fg="blue").pack(pady=15)
